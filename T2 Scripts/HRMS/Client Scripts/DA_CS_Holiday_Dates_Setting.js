...
define(['N/search','N/record','N/format'],
	...
	function fieldChanged(scriptContext) {
		try{
			if(scriptContext.fieldId == 'custrecord_da_holiday_end_date'){

				var startDate = scriptContext.currentRecord.getValue('custrecord_da_holiday_start_date');
				var endDate = scriptContext.currentRecord.getValue('custrecord_da_holiday_end_date');

				if(startDate && endDate){
					
					var numLines = scriptContext.currentRecord.getLineCount({
						sublistId: 'recmachcustrecord_da_holiday_parent'
					});
					...
					dates.forEach(function(date) {
						...
						scriptContext.currentRecord.setCurrentSublistValue({
							sublistId:'recmachcustrecord_da_holiday_parent',
							fieldId:'custrecord_holiday_date',
							value:date
						});
