...
define(['N/record', 'N/search', 'N/runtime'],
    function(record, search, runtime) {
        ...
        function reduce(context) {
            ...
            var employeeWorkingSubsidary = empRecord.getValue('custentity_da_work_for_subsidiary');
              ...
              if(overrideSubsidiary && quickPay == false){
                // paycheckJournalRec.setValue('subsidiary', overrideSubsidiary);
              }
              ...
              //deleting pending claims
                ...
                var customrecord_da_pending_claims_for_emplySearchObj = search.create({
                   ...
                   [
                      ...
                      search.createColumn({name: "custrecord_da_pending_claim_employee", label: "Employee"}),
                      search.createColumn({name: "custrecord_da_pending_claim_amount", label: "Amount"}),
                      search.createColumn({name: "custrecord_da_pending_claim_month", label: "For Month"})
                   ]
                });
