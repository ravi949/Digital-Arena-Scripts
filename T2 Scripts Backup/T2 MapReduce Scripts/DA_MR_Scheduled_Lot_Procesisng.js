        ...
        function getInputData() {
            try {
                ...
                var customrecord_da_trans_inventory_detailSearchObj = search.create({
                   ...
                   filters:
                   [
                        [["created","onorafter","yesterday"],"OR",["lastmodified","onorafter","twodaysago"]], 
                          "AND", 
                          [["isinactive","is","F"]]
                   ],
                   columns:
                   [
                      ...
                      search.createColumn({name: "custrecord_da_inventory_detail_trans", label: "Transaction"}),
                      search.createColumn({name: "custrecord_da__trans_inv_detail_item", label: "Item"}),
                      search.createColumn({name: "custrecord_da_trans_inv_detail_location", label: "Location"}),
                      search.createColumn({name: "custrecord_da_trans_inv_detail_bin", label: "Bin"}),
                      search.createColumn({name: "custrecord_da_trans_inv_detail_number", label: "Number"}),
                      search.createColumn({name: "custrecord_da_trans_inv_detail_expiry", label: "Expiry Date"}),
                      search.createColumn({name: "custrecord_da_trans_inv_detail_quantity", label: "Quantity"}),
                      search.createColumn({name: "custrecord_da_transaction_lot_item", label: "Lot?"})
                   ]
                });
                ...
                customrecord_da_trans_inventory_detailSearchObj.run().each(function(result){
                   lotNosArray.push(result.getValue({ name :'custrecord_da_trans_inv_detail_number'}));
                   return true;
                });
                ...
                var customrecord_da_inventory_detailSearchObj = search.create({
                   ...
                   filters:
                   [
                      ["custrecord_da_inventory_detail_number","anyof",lotNosArray]
                   ],
                   columns:
                   [
                      
                      search.createColumn({name: "custrecord_da_inventory_detail_quantity", label: "Quantity"})
                   ]
                });
                ...
                var customrecord_da_trans_inventory_detailSearchObj = search.create({
                    type: "customrecord_da_trans_inventory_detail",
                    filters: [
                        ["isinactive", "is", "F"], "AND", ["custrecord_da_trans_inv_detail_number","anyof",lotNosArray]
                    ],
                    columns: [
                        search.createColumn({
