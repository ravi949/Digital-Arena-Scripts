        ...
        function reduce(context) {
            try {
              ...
              var custRecordSearch = search.create({
                    ...
                    columns: [ 
                    'internalid', 'custrecord_da_subsidiary', 'custrecord_da_currency_3', 'custrecord_da_preferred_vendor','custrecord_da_auto_po_location'
                    ],
                    filters: [
                    ['custrecord_da_schedule_auto', 'anyof', '3'],
                      "AND",
