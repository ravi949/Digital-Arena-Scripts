...
function(record, search, runtime, format) {
    ...
    function getInputData() {
        try {
            return itemBrandSearch = search.create({
                type: 'classification',
                columns: [
                    'internalid'
                ],
             //   filters: ['internalid', 'anyof', '346']
    ...
    function reduce(context) {
        try {
            ...
            var itemBrandId = recordId.value.id;
            log.debug('itemBrandId', itemBrandId);
            ...
            var mySearch = search.create({
                ...
                filters: [
                    ...
                    "AND",
                    ["inventorylocation", "anyof", "3"], // to location
                    "AND",
                    ["reorderpoint", "greaterthan", "0"],
                    "AND",
                    ["class", "anyof", itemBrandId],
                  //  "AND",
                  //  ["internalid", "anyof", '17540'],
                            ...
                            var lotItemSearch = search.create({
                                ...
                                filters: [
                                   ...
                                   // ["inventorydetail.status", "anyof", 1],
                                    //"AND",
                                    ["inventorynumber.location", "anyof", 4], // from location
                                    "AND",
                                    ...
                                    "AND",
                                    ["inventorylocation", "anyof", 4] //from Location
                                ],
                                columns: [
                                    search.createColumn({
                                        name: "expirationdate",
                                ...
                                if (count > 0) {
                                    ...
                                    lotItemSearch.run().each(function(result) {
                                            ...
                                            if (remQty != 0) {
                                                ...
                                                if (remQty > 0) {
                                                    if (availQty > 0) {
                                                        //log.debug('set inventory detail');
