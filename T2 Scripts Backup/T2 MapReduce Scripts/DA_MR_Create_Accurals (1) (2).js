...
define(['N/https', 'N/record', 'N/runtime', 'N/url', 'N/search', 'N/format'],
   ...
   filters:
   [
      ["type","anyof","Custom115"], 
      "AND", 
      ["memo","startswith","Indem"], 
      "AND", 
...
transactionSearchObj.run().each(function(result){
   ...
   return true;
                ...
                /* var month = (new Date("04/01/2021").getMonth());
                 var monthsobj = {
                     '1': 'Jan',
                     '2': 'Feb',
                     '3': 'Mar',
                 ...
                 //var year = new Date("04/01/2021").getFullYear();
                 if (month == 0 || month == "0") {
                     year = year - 1;
                 }
                ...
                var postingPeriod = scriptObjPeriod.getParameter({
                    name: 'custscript_da_indemnity_post_period'
                });
        ...
        function map(context) {
            try {
                ...
                var customrecord_da_accrualsSearchObj = search.create({
                    ...
                    filters: [
                        ["custrecord_da_acc_main_category", "anyof", "53"], "AND",
        ...
        function reduce(context) {
            try {
                ...
                var dateObj = scriptObjDate.getParameter({
                    name: 'custscript_da_indemnity_dates'
                });
        ...
        function summarize(summary) {
            try {
                ...
                var recordId = scriptObj.getParameter({
                    name: 'custscript_da_indemnity_record_id'
                });
                ...
                var processRec = record.submitFields({
                    ...
                    id: recordId,
                    values: {
                        'custrecord_da_generate_journal': false
                    }
                });
