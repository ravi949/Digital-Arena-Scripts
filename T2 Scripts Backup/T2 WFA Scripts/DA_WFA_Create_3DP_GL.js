    ...
    function(task, search, record) {
        ...
        function onAction(scriptContext) {
            try {
                ...
                var newAmount = 0;
                var glAccountDebit = scriptContext.newRecord.getValue('custbody_da_customer_ar_account');
                ...
                if(amountDue < 0){
                    ...
                    trialBalRec.setValue('custrecord_da_gl_impact_transaction_type',7);
                    ...
                    trialBalRecord.setValue('custrecord_da_gl_impact_transaction_type',7);
