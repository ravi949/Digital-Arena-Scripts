...
//              push the script into the field so that it fires and does its handy work
              ...
              /* var customrecord_da_pending_receiving_kbbSearchObj = search.create({
               ...
               filters:
               [
                  ["custrecord_da_kbb_recieve","is","T"]
               ],
               columns:
               [
            ...
            customrecord_da_pending_receiving_kbbSearchObj.run().each(function(result){
                record.submitFields({
                            ...
                            id: result.id,
                            values:{
                                'custrecord_da_kbb_recieve': false
                            }
                });
               return true;
            });*/
 ...
 log.debug('numLines', numLines);	
                    ...
                    if(checked == "T"){
                       ...
                       log.debug('recordId', recordId);
                        record.submitFields({
                            ...
                            id: recordId,
                            values:{
                                'custrecord_da_kbb_recieve': true
                            }
                        });
                     var rec1 = record.create({
                          type :'customrecord_da_pending_receiving_kbb2'
                        });
                      rec1.setValue('custrecord_da_kbb_transfer_order_ref', recId);
                       rec1.setValue('custrecord_da_ref_record_kbb', recordId);
                 var recId1 = rec1.save();
                    }
                }
              }
             /* record.submitFields({
                ...
                id : 1,
                values :{
                  'custrecord_da_receieve_kbb' : true,
                  'custrecord_da_issuing_to_apple': false,
                  'custrecord_da_recieve_kbb_memo' :'',
                  'custrecord_da_kbb_inv_adj_ref':''
                }
              })*/
    ...
    function searchForPendingFullfillmentData(techinicanId, jobcardId, item) {
        var customrecord_da_pending_receiving_kbbSearchObj = search.create({
            ...
            filters:
                [
                    ["custrecord_da_job_card_transfer_ordr_ref","anyof","1"],"AND",["custrecord_da_kbb_issued", "is", false],"AND",["isinactive", "is", false]
                    ],
                    columns:
                        [
