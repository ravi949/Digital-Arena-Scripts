            ...
            try {
              ...
              if(context.fieldId == 'custpage_ss_pagination'){
                    ...
                    var output = url.resolveScript({
                        scriptId: 'customscript_da_su_fun_currency_report_1',
                        deploymentId: 'customdeploy_da_su_fun_currency_report_1',
                ...
                if (context.fieldId == 'custpage_ss_vendor' || context.fieldId == 'custpage_ss_end_date' || context.fieldId == 'custpage_ss_start_date' || context.fieldId == 'custpage_ss_subsidiary' || context.fieldId == 'custpage_ss_currency'){
                       ...
                       var output = url.resolveScript({
                        ...
                        deploymentId: 'customdeploy_da_su_fun_currency_report_1',
                            ...
                            params: {
                              ...
                              currency: context.currentRecord.getValue('custpage_ss_currency')
                            }
