		...
		function saveRecord(scriptContext) {
			try {
				...
				if (date) {
					...
					var requester = objRecord.getValue('custbody_da_po_created_by');
					var requesterName = objRecord.getText('custbody_da_po_created_by');
