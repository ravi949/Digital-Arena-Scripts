...
define(['N/search', 'N/url', 'N/https'],
  ...
  var fieldId ="location";
        ...
        function pageInit(scriptContext) {
          ...
          if(scriptContext.currentRecord.type == "invoice" || scriptContext.currentRecord.type == "creditmemo" || scriptContext.currentRecord.type == "vendorbill" || scriptContext.currentRecord.type == "vendorcredit"){
                      sublistId = "item";
                    }
                     if(scriptContext.currentRecord.type == "inventoryadjustment"){
                        sublistId = "inventory";
                       fieldId = 'adjlocation';
                     }
        }
        ...
        function fieldChanged(scriptContext) {
            try {
                      ...
                      var location = scriptContext.currentRecord.getValue(fieldId);
        ...
        function saveRecord(scriptContext) {
            try {
              ...
              if(scriptContext.currentRecord.type == "invoice" || scriptContext.currentRecord.type == "creditmemo" || scriptContext.currentRecord.type == "vendorbill" || scriptContext.currentRecord.type == "vendorcredit"){
               ...
               var itemLc = scriptContext.currentRecord.getLineCount(sublistId);
                var itemsObj = {};
                var lotInvNosArray = [];
