    ...
    function(search, record, format, currentRecord) {
        ...
        function pageInit(scriptContext) {
            try {
                ...
                var recId = scriptContext.currentRecord.getValue('custbody_da_customer_payment_ref');
                console.log('recId', recId);
                var custPaymentRec = record.load({
                    type: 'customerpayment',
                    id: recId
                });
                var customer = custPaymentRec.getValue('customer');
                console.log('customer', customer);
                var subsidiary = custPaymentRec.getValue('subsidiary');
                console.log('subsidiary', subsidiary);
                var department = custPaymentRec.getValue('department');
                console.log('department', department);
                var classId = custPaymentRec.getValue('class');
                console.log('classId', classId);
                var location = custPaymentRec.getValue('location');
                console.log('location', location);
                scriptContext.currentRecord.setValue('entity', customer);
                ...
                var custPaymentAmount = custPaymentRec.getSublistValue({
                    sublistId: 'apply',
                    fieldId: 'amount',
                    line: 0
                });
                console.log('custPaymentAmount', custPaymentAmount);
