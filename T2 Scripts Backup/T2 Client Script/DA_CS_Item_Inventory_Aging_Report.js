        ...
        function fieldChanged(context) {
            ...
            try {
               // var Contract = context.currentRecord;
                if (context.fieldId == 'custpage_posting_period' || context.fieldId == 'custpage_item_category'){
                    var postingPeriod = context.currentRecord.getValue('custpage_posting_period');
                    var itemCategory = context.currentRecord.getValue('custpage_item_category');
                       var output = url.resolveScript({
                            scriptId: 'customscript_da_su_item_inv_aging_report',
                            deploymentId: 'customdeploy_da_su_item_inv_aging_report',
