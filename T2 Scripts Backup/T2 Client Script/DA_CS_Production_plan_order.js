...
define(['N/search','N/record','N/format','N/url'],
	...
	function pageInit(scriptContext) {
		try{
			...
			{
           var productionSettingsRec = record.load({
           	type:'customrecord_da_production_settings',
           	id:1
           });
           var ProductionCustomer = productionSettingsRec.getValue('custrecord205');
           scriptContext.currentRecord.setValue('entity',ProductionCustomer);
           }
