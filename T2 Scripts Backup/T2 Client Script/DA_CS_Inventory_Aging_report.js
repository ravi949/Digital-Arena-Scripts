        ...
        function fieldChanged(context) {
            ...
            try {
               // var Contract = context.currentRecord;
                if (context.fieldId == 'custpage_posting_period' || context.fieldId == 'custpage_item_categeory'){
                    var postingPeriod = context.currentRecord.getValue('custpage_posting_period');
                    var itemCategeoryField = context.currentRecord.getValue('custpage_item_categeory');
                       var output = url.resolveScript({
                            ...
                            params: {
                                ...
                                itemCategeoryField: itemCategeoryField
                            }
